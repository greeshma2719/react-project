...
export default function ProductsDetails() {
  ...
  return (
    ...
    <div className='detailspage py-20 px-34 '>
      ...
      <div className='side  col-md-1 d-flex flex-column align-items-center gap-3 py-4 '>
         <img src={Products.images[0]} alt="" className='sideimage mb-3 ml-3' />
        <img src={Products.images[1]} alt="" className='sideimage mb-3 ml-3' />
        <img src={Products.images[2]} alt="" className='sideimage mb-3 ml-3' />
        <img src={Products.images[3]} alt="" className='sideimage mb-3 ml-3' />
      </div>
